...
using PracticaMad.Web.HTTP.Util;
using PracticaMad.Web.HTTP.View.ApplicationObjects;
...
namespace PracticaMad.Web.HTTP.Session
{
    ///<summary>
    ///
    ...
    public class SessionManager
    {
        ...
        {
            /* Register user. */
            Usuario user = userService.RegisterUser(loginName, clearPassword,
                userProfileDetails);
             ...
             Boolean rememberMyPassword)
        {
            LoginResult loginResult =
                userService.LoginUser(loginName, password,
                    passwordIsEncrypted);
            ...
            UserProfileDetails userProfileDetails)
        {
            ...
            userSession.UserName = userProfileDetails.FirstName;
